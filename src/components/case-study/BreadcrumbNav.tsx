...
export default function BreadcrumbNav({ projectTitle }: Props) {
  return (
    <nav aria-label="Breadcrumb" className="pt-8 md:pt-12 mb-12">
      <ol className="flex flex-wrap items-center gap-2 text-base md:text-lg text-white/90">
        <li>
        ...
        <li className="text-white/90">/</li>
        <li className="text-cyan-300 truncate max-w-[200px] sm:max-w-none" title={projectTitle}>
          {projectTitle}
        </li>
      </ol>
    </nav>
