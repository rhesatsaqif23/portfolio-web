...
import { ExternalLink, Github, X, ArrowUpRight, BookOpen } from "lucide-react";
              ...
              <div className="p-6 sm:p-7 md:p-10 grid md:grid-cols-2 gap-8 md:gap-10 max-h-[85vh] overflow-y-auto">
                ...
                <div className="flex flex-col space-y-5 md:space-y-6 justify-center">
                  <div className="flex items-center gap-3">
                    ...
                    {project.category && (
                      <span className="inline-flex items-center shrink-0 rounded-full border border-cyan-400/40 px-3 py-1 text-xs md:text-sm font-semibold text-cyan-300 bg-cyan-400/10">
                        {project.category}
                      </span>
                    )}
                  </div>
                      ...
                      >
                        <div className="relative h-[1.6em] overflow-hidden w-max">
                          ...
                          <div
                            ...
                            "
                          >
                            <span className="text-sm md:text-base font-semibold text-white whitespace-nowrap">View Case Study</span>
